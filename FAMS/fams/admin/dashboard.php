...
<div class="col-16 justify-content-center">
    <div class="col-md-14">
        <div class="widget">
    ...
    $(document).ready(function () {
        ...
        $('#calendar').fullCalendar({
            ...
            eventRender: function (event, element) {
                ...
                element.find('.fc-title').append( + event.title || event.description);
            },
            eventClick: function (calEvent, jsEvent, view) {
                ...
                // Add logic here to fetch additional details based on the clicked faculty name
                // You may need to make an AJAX call to the server to retrieve the details from tblappointment
