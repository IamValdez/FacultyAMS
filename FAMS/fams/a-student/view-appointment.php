                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Faculty Concern</th>
                                                <th class="text-center">Appointment Concern</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <?php } else { ?>
                                                            <td class="text-center"><?php echo htmlentities($row->Remark);?></td>
                                                        <?php } ?>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" onclick="deleteAppointment(<?php echo htmlentities($row->sID); ?>)" class="btn btn-primary">Edit</button>
                                                        </td>
