...
function AppointMentMailer($aptNumber, $aptEmail, $aptName, $aptDate, $aptTime, $facultyList , $aptconcern)
{
...
<body>
    <div class="container">
        ...
        <p><strong>Appointment Number:</strong> <span class="appointment-number">' . $aptNumber . '</span></p>
        <p><strong>Faculty: </strong>' . $facultyList . '</p>
        <p><strong>Concern: </strong>' . $aptconcern . '</p>
...
if (isset($_POST['submit'])) {
  ...
  //  $message = "HELLO";
    ...
    $month = date('m');
    $day = date('d');
    $aptnumber = $prefix . $year . $month . $day . $random_suffix;
    $cdate = date('Y-m-d');
    ...
    Swal.fire({
        ...
        $sql = "insert into tblappointment(AppointmentNumber,Name,user_ID,MobileNumber,Email,AppointmentDate,AppointmentTime,Specialization,Faculty,Message,Concern)values(:aptnumber, :Fname,:STid,:mobnum,:email,:appdate,:aaptime,:specialization,:facultylist,:message,:consid)";
        ...
        $query->bindParam(':consid', $consid, PDO::PARAM_STR);
        ...
        if (isset($_POST['submit'])) {
            AppointMentMailer($aptnumber, $email, $Fname, $appdate, $aaptime, $facultylist , $consid);
            echo '<script>';
                            ...
                            <div class="booking-form">
                                ...
                                <form role="form" method="post">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="col-12">
                                            <select class="control" name="concernid">
                                                <option value="" hidden>Types of Concern</option>
                                                <?php
                                                $sql1 = "SELECT * from tblconcern";
                                                ...
                                                if ($query1->rowCount() > 0) {
                                                    foreach ($results1 as $row1) { ?>
                                                        <option value="<?php echo htmlentities($row1->Concern); ?>"><?php echo htmlentities($row1->Concern); ?></option>
                                                <?php $cnt = $cnt + 1;
                                                    }
                                                } ?>
                                            </select>
